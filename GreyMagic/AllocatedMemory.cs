...
namespace GreyMagic
{
    public class AllocatedMemory : IDisposable
    {
        ...
        public AllocatedMemory(ExternalProcessReader memory, int bytes)
        {
            _memory = memory;
        ...
        public void Write(string allocatedName, string value)
        {
            if (!_allocated.ContainsKey(allocatedName))
            {
        ...
        public void WriteString(string allocatedName, int offsetInBytes, string value, Encoding encoding)
        {
        ...
        /// <param name="encoding">The encoding.</param>
        /// <remarks>Created 2012-04-23</remarks>
        public void WriteString(int offsetInBytes, string value, Encoding encoding)
        {
        ...
        /// <returns></returns>
        /// <remarks>Created 2012-02-15</remarks>
        public T Read<T>(string allocatedName, int offset) where T : struct
        {
        ...
        /// <returns></returns>
        /// <remarks>Created 2012-02-15</remarks>
        public IntPtr GetAllocatedChunk(string allocatedName)
        {
        ...
        /// <returns></returns>
        /// <remarks>Created 2012-02-15</remarks>
        public static uint CalculateTotalSize(params uint[] sizes)
        {
            uint totalSize = 0;
